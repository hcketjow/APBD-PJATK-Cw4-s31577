    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComponentManifacturers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Components_ComponentManifacturers_ComponentManufacturersId",
                        column: x => x.ComponentManufacturersId,
                        principalTable: "ComponentManifacturers",
                        principalColumn: "Id",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "NV", new DateTime(1993, 4, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "NVIDIA Corporation" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Gamer Pro X", 10, 24, 12.5f },
                    { 2, new DateTime(2024, 3, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Office Basic", 25, 12, 8.2f }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "CPU0000001", 1, 1, "Procesor 16-rdzeniowy, taktowanie do 5.4 GHz", "Intel Core i7-13700K" },
                    { "CPU0000002", 2, 1, "Procesor 8-rdzeniowy z pamięcią 3D V-Cache", "AMD Ryzen 7 7800X3D" },
                    { "GPU0000001", 3, 2, "Karta graficzna 12 GB GDDR6X", "NVIDIA GeForce RTX 4070" }
                });
